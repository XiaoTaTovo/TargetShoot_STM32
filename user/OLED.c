...
void OLED_Init(void)
{
    /* * 注意：这里删除了原来的 OLED_GPIO_Init();
     * 因为 CubeMX 生成的代码 MX_I2C1_Init() 已经帮你把 PB6 和 PB7 初始化好了
     */
...
/* ======================================================= */
/* ====== 往下不用改，保留你原来 OLED_SetCursor 及之后的全部代码 ====== */
/* ======================================================= */
